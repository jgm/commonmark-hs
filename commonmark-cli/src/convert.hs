...
styles = "<style>\n" <> fromText (T.unlines
  ...
  , ".header1 { font-weight: bold; color: purple; }"
  , ".header2 { font-weight: bold; color: purple; }"
  , ".header3 { font-weight: bold; color: purple; }"
  , ".header4 { font-weight: bold; color: purple; }"
  , ".header5 { font-weight: bold; color: purple; }"
  , ".codeBlock { color: black; background-color: #eeeeee; }"
  , ".rawInline { color: green; }"
  , ".rawBlock { color: green; }"
