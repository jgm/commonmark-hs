* TODO end-of-heading attributes...
don't work properly w implicit_heading_references
because they are not resolved til the blockConstructor
phase. Same might be true for thingsi like fenced code
block attributes.
Create a better system for putting these into blockAttributes,
and stripping out the relevant tokens, in the finalize stage.
