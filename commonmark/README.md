...
- **[`commonmark-extensions`](https://github.com/jgm/commonmark-hs/commonmark-extensions/)**
...
- **[`commonmark-pandoc`](https://github.com/jgm/commonmark-hs/commonmark-pandoc/)** defines
  type instances for parsing commonmark as a Pandoc AST.

- **[`commonmark-cli`](https://github.com/jgm/commonmark-hs/commonmark-cli/)** is a
